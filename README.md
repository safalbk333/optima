...
```
cd existing_repo
git remote add origin https://git.gnxsolutions.app/optima/optima_backend.git
git branch -M main
...
* [Set up project integrations](https://git.gnxsolutions.app/optima/optima_backend/-/settings/integrations)
...
Before run in local run below script in root folder

for local developement
    node scripts/env.js development
