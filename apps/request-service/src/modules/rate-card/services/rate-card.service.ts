...
export class RateCardService {
  private readonly logger = new AppLogger(RateCardService.name);
  ...
  async create(dto: CreateRateCardDto, userId: string) {
    try {
      ...
      return ResponseHelper.success(this.toResponseDto(rateCard), 'Rate card created successfully');
    } catch (error: any) {
  ...
  async findAll(query: RateCardQueryDto) {
    try {
      ...
      return ResponseHelper.success({
        data: items.map((rc) => this.toResponseDto(rc, rc.vendor?.company_legal_name, rc.items?.length)),
        total,
        page,
        limit,
      }, 'Rate cards fetched successfully');
    } catch (error: any) {
      this.logger.error(error.stack || error.message);
      return ResponseHelper.error(error.message);
    }
  ...
  async findOne(id: string) {
    try {
      ...
      return ResponseHelper.success(this.toResponseDto(rateCard, rateCard.vendor?.company_legal_name, rateCard.items?.length), 'Rate card fetched successfully');
    } catch (error: any) {
      this.logger.error(error.stack || error.message);
      return ResponseHelper.error(error.message);
    }
  ...
  async update(id: string, dto: UpdateRateCardDto, userId: string) {
    try {
      ...
      return ResponseHelper.success(this.toResponseDto(updated), 'Rate card updated successfully');
    } catch (error: any) {
      this.logger.error(error.stack || error.message);
      return ResponseHelper.error(error.message);
    }
  ...
  async remove(id: string, userId: string) {
    try {
      ...
      return ResponseHelper.success(null, 'Rate card deleted successfully');
    } catch (error: any) {
      this.logger.error(error.stack || error.message);
      return ResponseHelper.error(error.message);
    }
  ...
  async activate(id: string, userId: string) {
    try {
      ...
      return ResponseHelper.success(this.toResponseDto(updated), 'Rate card activated successfully');
    } catch (error: any) {
      this.logger.error(error.stack || error.message);
      return ResponseHelper.error(error.message);
    }
  ...
  async deactivate(id: string, userId: string) {
    try {
      ...
      return ResponseHelper.success(this.toResponseDto(updated), 'Rate card deactivated successfully');
    } catch (error: any) {
      this.logger.error(error.stack || error.message);
      return ResponseHelper.error(error.message);
    }
  ...
  async clone(id: string, dto: CloneRateCardDto, userId: string) {
    try {
      ...
      return ResponseHelper.success(this.toResponseDto(cloned), 'Rate card cloned successfully');
    } catch (error: any) {
      this.logger.error(error.stack || error.message);
      return ResponseHelper.error(error.message);
    }
  ...
  async getActive() {
    try {
      ...
      return ResponseHelper.success(items.map((rc) => this.toResponseDto(rc, rc.vendor?.company_legal_name)), 'Active rate cards fetched successfully');
    } catch (error: any) {
      this.logger.error(error.stack || error.message);
      return ResponseHelper.error(error.message);
    }
  ...
  async getExpired() {
    try {
      ...
      return ResponseHelper.success(items.map((rc) => this.toResponseDto(rc, rc.vendor?.company_legal_name)), 'Expired rate cards fetched successfully');
    } catch (error: any) {
      this.logger.error(error.stack || error.message);
      return ResponseHelper.error(error.message);
    }
  ...
  async getExpiring(days: number) {
    try {
      ...
      return ResponseHelper.success(items.map((rc) => this.toResponseDto(rc, rc.vendor?.company_legal_name)), 'Expiring rate cards fetched successfully');
    } catch (error: any) {
      this.logger.error(error.stack || error.message);
      return ResponseHelper.error(error.message);
    }
